//Note the GDI manager stuff as well as the surface stuff is the manuel way of loading texture data
//there are libraries that do this so feel free to use those instead 
...
Surface Surface::FromFile(const std::string& name)
{
	...
	{
		// convert file name to a wide string (for Gdiplus)
...
{
	return "Nova Engine Graphics Exception";
}
